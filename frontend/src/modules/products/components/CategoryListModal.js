...
const CategoryListModal = ({isOpen, onClose, categories}) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div
                className="bg-white dark:bg-gray-900 shadow-xl rounded-lg p-6 w-[500px] border border-gray-300 dark:border-gray-700">
                ...
                <button
                    onClick={onClose}
                    className="mt-6 w-full py-3 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-all"
                >
                    Cerrar
                </button>
            </div>
